    ...
    public static void dfs5(node now,int i) throws Exception{
        ...
        if (now.type.equals("expression")){
            ...
            if (now.name.equals("function")){
                if (now.son.get(0).name.equals("print")){
                    if (now.son.size()!=2){
                ...
                if (now.son.get(0).name.equals("println")){
                    if (now.son.size()!=2){
                ...
                if (now.son.get(0).name.equals("getString")){
                    if (now.son.size()!=1){
                ...
                if (now.son.get(0).name.equals("getInt")){
                    if (now.son.size()!=1){
                ...
                if (now.son.get(0).name.equals("toString")){
                    if (now.son.size()!=2){
